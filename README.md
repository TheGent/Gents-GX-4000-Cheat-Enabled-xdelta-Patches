...
Here are Patches for use with [Delta Patcher](https://github.com/marco-calautti/DeltaPatcher/releases/) xdeleta tool.

Make sure your Games are the correct name and file type before patching! And remember to enable Backup original file so it creates Game name - CopyPATCHED.cpr
...
Name: Barbarian II (1990)(Ocean).cpr

Size: 131148 bytes (128 KiB)

CRC32: 07E0045E

CRC64: BCE332B8F7483E8B

SHA256: fd3a33c75443d55506e033cace63d0c267c98f27244661d0fee723a32c80f46e
...
Name: Batman - The Movie (1990)(Ocean).cpr

Size: 524556 bytes (512 KiB)

CRC32: E039FA68

CRC64: D8A7149285D4BF5A

SHA256: ce9cd345140f899cbab1dc3e7bbe0d83b6859ccb59693896d02b65dcb8994ab1
...
Name: Burnin' Rubber (1990)(Ocean).cpr

Size: 131148 bytes (128 KiB)

CRC32: 3130AF05

CRC64: 901B738A49A1D139

SHA256: 08c81e4aeca95abaecc3c196519e2aeb63d2f805b6e18c055a7a3cf49e51a1df
...
Name: Crazy Cars II (1990)(Titus).cpr

Size: 524556 bytes (512 KiB)

CRC32: ABF053E2

CRC64: 8D831F8115F0D53C

SHA256: 081352c8ded2b08dda9b5e75286aea316c65491447d1ceb29b5557239048b908
...
Name: Dick Tracy (1990)(Titus).cpr

Size: 131148 bytes (128 KiB)

CRC32: EFC718BF

CRC64: 89C0FD58BCDE9658

SHA256: 17300a5d607d0aa7a07508697f49336c2d34a681576e5464d1df7c1f1eeffee9
...
Name: Fire and Forget II (1990)(Titus).cpr
Size: 131148 bytes (128 KiB)
CRC32: E5A01687
CRC64: 42F3191319E4F179
...
Name: Klax (1990)(Domark).cpr

Size: 131156 bytes (128 KiB)

CRC32: FA33B29C

CRC64: 2C5E7D7C8BFFBC92

SHA256: 37cc6241bdedcce4b67bf6965191d8f7c4145a2674bc7daf50b2a6cb1d139792
...
Name: Mystical (1990)(Infogrames).cpr

Size: 131148 bytes (128 KiB)

CRC32: 94D44C07

CRC64: F4633A2057DAD47E

SHA256: 8e34ee16afdd342e0fbbdc4ad57cab031c5aec0e63058f76141234dab1cca3e2
